...
//             <div
//               key={match.id}
//               className="bg-card rounded-xl shadow-lg p-6 md:p-8 flex flex-col md:flex-row items-center justify-between transition-transform duration-300 transform hover:scale-105 hover:shadow-md"
//             >
//               {/* Match Details */}
